    ...
    , ui(new Ui::MainWindow)
{
    ...
    graphicWnd = new GraphicWindow(this);

    connect(this, &MainWindow::dataSeriesReady, graphicWnd, &GraphicWindow::UpdateGraphic);
    connect(graphicWnd, &GraphicWindow::readyToShow, this, &MainWindow::OpenGraphic);
}
